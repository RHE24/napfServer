...
_role2 = "Admins";
_role2names = ["Lucidity AKA (Lucy)", "Mr. SweetDick AKA (Mr. House)", "PuRe Colonel", "Trooper"];
_role3 = "Server mod";
_role3names = ["DayZ Epoch Napf"];
_role4 = "Server Mods";
_role4names = ["Select Spawn", "Action Menu", "Trader Safe Zones", "And much more"];
_role5 = "Website";
_role5names = ["sdsgaming.tekspace.net"];
_role6 = "Twitter";
_role6names = ["@MrSweetDick16", "@LucidAnonymity"];
 
{
	sleep 2;
	_memberFunction = _x select 0;
	_memberNames = _x select 1;
	_finalText = format ["<t size='0.40' color='#009FCF' align='right'>%1<br /></t>", _memberFunction];
